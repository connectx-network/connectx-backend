...
async function mintNft(collectionMint: PublicKey, candyMachine: PublicKey) {
  ...
  const owner = "5zoYDxn6tm1dauS3ZHoZJLnpbKp2dhjzyGfSvjvzd8ST";

  const nftMint = generateSigner(umi);
  // await transactionBuilder()
  //   .add(setComputeUnitLimit(umi, { units: 800_000 }))
  //   .add(createMintWithAssociatedToken(umi, { mint: nftMint, owner: owner as PublicKey }))
  //   .add(
  //     mintV2(umi, {
  //       candyMachine: candyMachine,
  //       nftMint: nftMint,
  ...
  //             "FgfGwN6bLR2ZzmGPhANXdFjQWpQVwo9d5REPnwkw5veD" // update to the admin's wallet address
  //           ),
  //         }),
  //       },
  //     })
